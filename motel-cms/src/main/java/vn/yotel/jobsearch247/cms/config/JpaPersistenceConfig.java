...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", basePackages = {
		"vn.yotel.admin", "vn.yotel.jobsearch247.core"})
...
public class JpaPersistenceConfig {
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN_CORE = "vn.yotel.jobsearch247.core.jpa";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan(new String[] { PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN, PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN_CORE });
